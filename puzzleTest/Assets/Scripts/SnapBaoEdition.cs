...
public class SnapBaoEdition : MonoBehaviour
{
    ...
    private DragAndDropBaoEdition dragFunction;
    ...
    void Start()
    {
        dragFunction = gameObject.transform.parent.GetComponent<DragAndDropBaoEdition>();
